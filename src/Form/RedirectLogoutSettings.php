...
class RedirectLogoutSettings extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['redirect_after_logout_destination'] = [
      ...
      '#default_value' => $config->get('redirect_after_logout_destination'),
    ];
    ...
    $form['redirect_after_logout_message'] = [
      ...
      '#default_value' => $config->get('redirect_after_logout_message'),
    ];
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (($value = $form_state->getValue('redirect_after_logout_destination')) && $value[0] !== '/') {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $config = $this->config('redirect_after_logout.settings');
    $config->set('redirect_after_logout_destination', $form_state->getValue('redirect_after_logout_destination'));
    $config->set('redirect_after_logout_message', $form_state->getValue('redirect_after_logout_message'));
    $config->save();
